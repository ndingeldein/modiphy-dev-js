var modiphy = ( function( modiphy, Backbone, _ ) {
	...
	_.extend( M.PageLoader.prototype, {
		...
		loadHTML: function( page ){
			...
			params = $.deparam.querystring(Backbone.history.fragment);
			...
			var req = $.get( 'layout/page/page.php', params ).done(function( data ){
	...
	M.Page = Backbone.Model.extend({
		...
		initialize: function(){
			...
			_.backboneDefault( this, 'id', 0 );

			_.backboneDefault( this, 'gallery_id', 0 );
